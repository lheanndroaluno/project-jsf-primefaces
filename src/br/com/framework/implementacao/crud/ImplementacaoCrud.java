...
@Component // Injeção de dependência do spring
@Transactional
public class ImplementacaoCrud<T> implements InterfaceCrud<T> {
	...
	private void validarTransaction() {
		// se não tiver transação ativa então entra na condição
		if (!sessionFactory.getCurrentSession().getTransaction().isActive()) {
			sessionFactory.getCurrentSession().beginTransaction();// inicia uma transação com o hibernate
		}
	}
