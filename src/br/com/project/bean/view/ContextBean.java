...
public class ContextBean implements Serializable {
	...
	public boolean possuiAcesso(String... acessos) {
		for (String acesso : acessos) {
			for(GrantedAuthority authority : getAuthentication().getAuthorities()) {/*aqui carrega os acessos do spring security*/
				/*condição para verificar se o usuário tem autorização*/
